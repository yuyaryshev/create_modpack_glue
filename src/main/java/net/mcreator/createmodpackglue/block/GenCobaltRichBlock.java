...
public class GenCobaltRichBlock extends Block {
	public GenCobaltRichBlock() {
	...
	public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
		...
		return Collections.singletonList(new ItemStack(CreateModpackGlueModItems.RAW_POOR_COBALT_ORE.get(), 64));
	}
}
