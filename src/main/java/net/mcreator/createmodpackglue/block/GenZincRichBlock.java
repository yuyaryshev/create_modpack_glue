...
public class GenZincRichBlock extends Block {
	public GenZincRichBlock() {
	...
	public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
		...
		return Collections.singletonList(new ItemStack(CreateModpackGlueModItems.RAW_POOR_ZINC_ORE.get(), 64));
	}
}
