...
public class WeaponMoltedIronBlock extends LiquidBlock {
	public WeaponMoltedIronBlock() {
		super(() -> (FlowingFluid) CreateModpackGlueModFluids.WEAPON_MOLTED_IRON.get(),
