...
public class AdvMoltenCleanerBlock extends LiquidBlock {
	public AdvMoltenCleanerBlock() {
		super(() -> (FlowingFluid) CreateModpackGlueModFluids.ADV_MOLTEN_CLEANER.get(),
