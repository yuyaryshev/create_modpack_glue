...
public class OreCustomTest1 extends OreFeature {
	public static OreCustomTest1 FEATURE = null;
	public static Holder<ConfiguredFeature<OreConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new OreCustomTest1();
		CONFIGURED_FEATURE = FeatureUtils.register("create_modpack_glue:gen_iron_poor", FEATURE,
				new OreConfiguration(OreCustomTest1RuleTest.INSTANCE, CreateModpackGlueModBlocks.GEN_IRON_POOR.get().defaultBlockState(), 26));
	...
	private static class OreCustomTest1RuleTest extends RuleTest {
		static final OreCustomTest1RuleTest INSTANCE = new OreCustomTest1RuleTest();
		private static final com.mojang.serialization.Codec<OreCustomTest1RuleTest> CODEC = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		private static final RuleTestType<OreCustomTest1RuleTest> CUSTOM_MATCH = () -> CODEC;
		...
		public boolean test(BlockState blockAt, Random random) {
			...
			return base_blocks.contains(blockAt.getBlock()) && random.nextInt(10)<5;
		}
