...
public class WeaponMoltedDiamondFluidAttributes extends FluidAttributes {
	public static CustomBuilder builder(ResourceLocation stillTexture, ResourceLocation flowingTexture) {
		return new CustomBuilder(stillTexture, flowingTexture, WeaponMoltedDiamondFluidAttributes::new);
	}
	...
	protected WeaponMoltedDiamondFluidAttributes(Builder builder, Fluid fluid) {
		super(builder, fluid);
	}
