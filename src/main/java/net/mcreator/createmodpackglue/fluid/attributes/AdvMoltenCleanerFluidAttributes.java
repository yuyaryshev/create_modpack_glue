...
public class AdvMoltenCleanerFluidAttributes extends FluidAttributes {
	public static CustomBuilder builder(ResourceLocation stillTexture, ResourceLocation flowingTexture) {
		return new CustomBuilder(stillTexture, flowingTexture, AdvMoltenCleanerFluidAttributes::new);
	}
	...
	protected AdvMoltenCleanerFluidAttributes(Builder builder, Fluid fluid) {
		super(builder, fluid);
	}
